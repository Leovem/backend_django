...
SECRET_KEY = 'django-insecure-w$falhvn@hz@15!-t7w+)+veotaf$o2*^r7&o666zv&u03xgp5'
...
ROOT_URLCONF = 'smartcar_backend.urls'
...
WSGI_APPLICATION = 'smartcar_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'fuVAnIpyQOjIBCJOrjXjXWbGcerZECbY',
